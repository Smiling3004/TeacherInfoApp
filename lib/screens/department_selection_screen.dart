...
//                     onTap: () {
//                       // Implement navigation to the particular department page
//                       navigateToDepartmentPage(context, 'CSIT');
//                     },
//                   ),
//               ),
//               SizedBox(height: 10),
...
//                   onTap: () {
//                     // Implement navigation to the particular department page
//                     navigateToDepartmentPage(context, 'AIML');
//                   },
//                 ),
//               ),
//               SizedBox(height: 10),
...
//                   onTap: () {
//                     // Implement navigation to the particular department page
//                     navigateToDepartmentPage(context, 'ETC');
//                   },
//                 ),
//               ),
//               SizedBox(height: 10),
...
//                   onTap: () {
//                     // Implement navigation to the particular department page
//                     navigateToDepartmentPage(context, 'Electrical');
//                   },
//                 ),
//               ),
//               SizedBox(height: 10),
...
//                   onTap: () {
//                     // Implement navigation to the particular department page
//                     navigateToDepartmentPage(context, 'Mechanical');
//                   },
//                 ),
//               ),
//               SizedBox(height: 10),
...
//                   onTap: () {
//                     // Implement navigation to the particular department page
//                     navigateToDepartmentPage(context, 'Mechatronics');
//                   },
//                 ),
//               ),
//               SizedBox(height: 10),
...
//                   onTap: () {
//                     // Implement navigation to the particular department page
//                     navigateToDepartmentPage(context, 'Automobile');
//                   },
//                 ),
//               ),
//               SizedBox(height: 10),
...
//                   onTap: () {
//                     // Implement navigation to the particular department page
//                     navigateToDepartmentPage(context, 'Civil');
//                   },
//                 ),
//               ),
//               SizedBox(height: 10),
...
//                   onTap: () {
//                     // Implement navigation to the particular department page
//                     navigateToDepartmentPage(context, 'Robotics');
//                   },
//                 ),
//               ),
//             ],
          ...
          children: [
            Padding(
              ...
              child: DepartmentCard(
                ...
                departmentLogo: 'assets/cse_logo.jpg', // Replace with CSE logo
                onTap: () {
                  // Implement navigation to the TeacherInfoPage with the selected department name
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => TeacherInfoPage(departmentName: 'Computer Engineering')),
                  );
                },
            ...
            Padding(
              ...
              child: DepartmentCard(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => TeacherInfoPage(departmentName: 'Information Technology')),
                  );
                },
              ),
            ),
            ...
            Padding(
              ...
              child: DepartmentCard(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => TeacherInfoPage(departmentName: 'Artificial Intelligence & Machine Learning')),
                  );
                },
              ),
            ),
            ...
            Padding(
              ...
              child: DepartmentCard(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => TeacherInfoPage(departmentName: 'Electronics & Telecommunication Engineering')),
                  );
                },
              ),
            ),
            ...
            Padding(
              ...
              child: DepartmentCard(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => TeacherInfoPage(departmentName: 'Electrical Engineering')),
                  );
                },
              ),
            ),
            ...
            Padding(
              ...
              child: DepartmentCard(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => TeacherInfoPage(departmentName: 'Mechanical Engineering')),
                  );
                },
              ),
            ),
            ...
            Padding(
              ...
              child: DepartmentCard(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => TeacherInfoPage(departmentName: 'Mechatronics Engineering')),
                  );
                },
              ),
            ),
            ...
            Padding(
              ...
              child: DepartmentCard(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => TeacherInfoPage(departmentName: 'Automobile Engineering')),
                  );
                },
              ),
            ),
            ...
            Padding(
              ...
              child: DepartmentCard(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => TeacherInfoPage(departmentName: 'Civil Engineering')),
                  );
                },
              ),
            ),
            ...
            Padding(
              ...
              child: DepartmentCard(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => TeacherInfoPage(departmentName: 'Robotics and Automation')),
                  );
                },
              ),
            ),
